...
It has capability to calculate monthly average. It is taking as input the value of  the odel and the observed data with their corresponding start and end date of date as input.
