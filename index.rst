...
It has capability to calculate montly average. It is taking the model and the observed data with their corresponding start and end date of date as input.
Contents:
